/* eslint-disable no-unused-vars, import/no-unresolved, func-style, arrow-parens, max-len, max-statements, no-undef, no-lonely-if */
import './ScriptEditor.css';
import '../../node_modules/draft-js-side-toolbar-plugin/lib/plugin.css';
import { ContentBlock, ContentState, Editor, EditorState, RichUtils, convertFromRaw, convertToRaw, genKey } from 'draft-js';
